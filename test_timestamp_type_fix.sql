-- TEST: Fix for timestamp type mismatch
-- This script tests the fixed get_free_mining_status function
...
BEGIN
    ...
    IF test_user_id IS NOT NULL THEN
        RAISE NOTICE '🧪 Testing timestamp type fix with User ID: %', test_user_id;
        ...
        RAISE NOTICE '   ✅ Sessions Used: %', test_result.sessions_used;
        RAISE NOTICE '   ✅ Max Sessions: %', test_result.max_sessions;
        RAISE NOTICE '   ✅ Sessions Remaining: %', test_result.sessions_remaining;
        RAISE NOTICE '   ✅ Can Mine: %', test_result.can_mine;
        RAISE NOTICE '   ✅ End Date: %', test_result.end_date;
        ...
        IF test_result.can_mine IS NOT NULL THEN
            RAISE NOTICE '🎉 SUCCESS! Timestamp type mismatch fixed!';
        ELSE
