      ...
      {/* Compact Header */}
       <header className="px-6 pt-8 pb-4 flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            <div className="text-[10px] font-black uppercase tracking-[0.4em] text-white leading-none mb-1">Rhiza Wallet</div>
          ...
          <div className="p-4 bg-zinc-900/40 border border-white/5 rounded-2xl flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <div className="text-[10px] font-mono text-zinc-400">{tonAddress.slice(0, 10)}...{tonAddress.slice(-6)}</div>
              </div>
            </div>
            <button 
              onClick={() => { 
