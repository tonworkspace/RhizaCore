...
// import { Gift, Send, Wallet, Shield, Calendar, Info, Copy, Check, AlertCircle } from 'lucide-react';
...
//         {/* RhizaCore Airdrop Card - Matching AirdropCards Design */}
...
//               <div className="relative z-10">
//                 {/* Header with Icon */}
//                 <div className="flex items-center justify-start text-left gap-2 mb-3">
//                   <div className="p-2 rounded-lg bg-green-500/10 border border-green-500/20">
//                     <Gift className="w-6 h-6 text-green-400" />
//                   </div>
//                   <h1 className="text-xl font-bold text-white">RhizaCore Airdrop</h1>
//                 </div>
...
//           </div>
//         )}
//         {/* Mining Balance Card - Matching AirdropCards Design */}
//         <div className="relative overflow-hidden rounded-2xl font-mono 
//                         bg-gradient-to-br from-black via-[#0a0a0f] to-black
//                         border border-green-500/20
//                         shadow-[0_0_30px_rgba(34,197,94,0.1)]
...
//               <div className="text-green-400 text-xl sm:text-2xl md:text-3xl font-bold animate-bounce drop-shadow-[0_0_8px_rgba(34,197,94,0.8)]">
//                 +{recentEarnings.toFixed(6)} RZC
//               </div>
//             </div>
//           )}
          
//           {/* Circular Mining Indicator - From Old UI (Enhanced) */}
//           <div className={`relative w-32 h-32 sm:w-16 sm:h-16 md:w-20 md:h-20 mx-auto mb-3 sm:mb-4 rounded-full flex items-center justify-center transition-all duration-300 ${
//             isMining 
//               ? 'bg-green-500/20 border-2 border-green-400/50 shadow-[0_0_20px_rgba(34,197,94,0.3)]' 
//               : 'bg-gray-700/50 border-2 border-gray-600/50'
//           }`}>
//             {isMining && (
//               <div className="absolute inset-0 rounded-full border border-green-400/40 animate-spin" style={{ animationDuration: '3s' }} />
//             )}
...
//               isMining 
//                 ? 'bg-green-500/40 border border-green-400/50 shadow-[0_0_15px_rgba(34,197,94,0.4)]' 
//                 : 'bg-gray-700/60 border border-gray-600/50'
//             }`}>
//               <div className={`w-5 h-5 sm:w-6 sm:h-6 md:w-7 md:h-7 rounded-full transition-all duration-300 ${
//                 isMining ? 'bg-green-400 animate-pulse shadow-[0_0_10px_rgba(34,197,94,0.6)]' : 'bg-gray-600'
//               }`}></div>
//             </div>
//           </div>

//           {/* Balance Text - From Old UI (Enhanced) */}
//           <div className="relative z-10">
//             <h3 className="text-4xl sm:text-2xl md:text-3xl lg:text-4xl font-bold text-green-300 tabular-nums mb-1 sm:mb-2 drop-shadow-[0_0_8px_rgba(34,197,94,0.3)]">
//             {isLoadingBalance ? (
//               <div className="flex flex-col items-center justify-center gap-3">
//                 {/* Enhanced Mining Animation */}
//                 <div className="relative">
//                   {/* Outer rotating ring */}
//                   <div className="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 border-4 border-green-500/30 border-t-green-400 rounded-full animate-spin"></div>
//                   {/* Inner pulsing circle */}
//                   <div className="absolute inset-2 border-2 border-green-400/50 rounded-full animate-ping"></div>
//                   {/* Center mining icon */}
//                   <div className="absolute inset-0 flex items-center justify-center">
//                     <div className="w-6 h-6 sm:w-8 sm:h-8 md:w-10 md:h-10 bg-green-400 rounded-full flex items-center justify-center animate-pulse shadow-[0_0_10px_rgba(34,197,94,0.8)]">
//                       <svg className="w-3 h-3 sm:w-4 sm:h-4 md:w-5 md:h-5 text-black" fill="currentColor" viewBox="0 0 24 24">
...
//                   <span className="text-sm sm:text-base md:text-lg text-green-400 font-medium">Loading</span>
...
//             {/* Statistics Cards - Matching AirdropCards Design */}
//           {!isLoadingBalance && (
//               <div className="relative z-10 mt-2 sm:mt-3 md:mt-4 space-y-3">
...
//                                   shadow-[0_0_10px_rgba(34,197,94,0.05)]
//                                   hover:shadow-[0_0_15px_rgba(34,197,94,0.1)]
//                                   backdrop-blur-sm
//                                   transition-all duration-300 ease-out">
//                     <div className="absolute inset-0 bg-gradient-to-br from-green-500/5 to-transparent rounded-xl pointer-events-none"></div>
//                     <span className="relative text-xs sm:text-sm font-medium text-green-400/90">{t('mining_label')}</span>
//                     <span className="relative text-xs sm:text-sm md:text-base font-semibold text-green-300 tabular-nums">{accumulatedRZC.toFixed(6)} RZC</span>
//                 </div>
//               )}
//                 <div className="relative flex items-center justify-between p-3
...
//                                 shadow-[0_0_10px_rgba(168,85,247,0.05)]
...
//                   <span className="relative text-xs sm:text-sm font-medium text-purple-400/90">{t('validated_label')}</span>
//                   <span className="relative text-xs sm:text-sm md:text-base font-semibold text-purple-300 tabular-nums">{claimedRZC.toFixed(6)} RZC</span>
//               </div>
//             </div>
//           )}
          
//             {/* Action Button - Matching AirdropCards Design */}
//           <div className="relative z-20 mt-3 sm:mt-4 md:mt-5">
//           <button
//             onClick={startMining}
//             disabled={isMining || !canStartMining}
//                 className={`relative w-full rounded-xl font-semibold py-3 sm:py-3.5 md:py-4 px-4 sm:px-5 md:px-6 text-xs sm:text-sm md:text-base transition-all duration-300 flex items-center justify-center gap-2 overflow-hidden
...
//                 <div className={`relative flex items-center justify-between p-3 mb-3 rounded-xl border transition-all duration-300 ${
